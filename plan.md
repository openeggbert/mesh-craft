...
- **Resolved:** commit `491f278` — verify: `ctest -R mc3_json_load_policy`
...
### AUD-069 `[TODO]` `P3` `W1` · includePathWithinRoot() wrongly rejects a same-directory relative resource reference when the target doesn't exist on disk and the document was opened via a bare relative filename
