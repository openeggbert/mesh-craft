...
| Commit | Change |
|-----------|-------------------------------------------------------------------------|
| (pending) | Isolate selection: Alt+I hides all non-selected objects and saves prior visibility; Alt+I again restores exact previous state; ISOLATED badge in stats overlay; Edit menu |
