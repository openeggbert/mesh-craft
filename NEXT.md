...
| Commit | Change |
|-----------|-------------------------------------------------------------------------|
| (pending) | Object locking: Ctrl+L / Edit menu / hierarchy context menu; [L] prefix in hierarchy; locked objects immune to gizmo, nudge and delete; stored as set<id> in editor |
