...
| Commit | Change |
|-----------|-------------------------------------------------------------------------|
| (pending) | Hide selected (H) / Show all hidden (Alt+H): keyboard shortcuts + Edit menu items; clears selection on hide; both push undo; documented in Keyboard Shortcuts dialog |
