...
| Commit | Change |
|-----------|-------------------------------------------------------------------------|
| (pending) | Animation round-trip tests: 43 new checks covering linear/cubic-bezier/step XML round-trip, multi-action round-trip, and evaluateChannel correctness (97 total) |
