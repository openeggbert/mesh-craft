...
// Source compatibility for integrations that still construct the editor as
// MeshCraft::MeshCraftApplication. New code should use
// MeshCraft::Application::MeshCraftApplication, which reflects its ownership
// boundary and matches the Application/UI source layout.
namespace MeshCraft {
using MeshCraftApplication = Application::MeshCraftApplication;
} // namespace MeshCraft
