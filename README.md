...
- Asset-definition LOD for Instances: authored near/mid/far definitions,
  hysteresis, maximum-distance culling, and selected-instance debug state;
  this is separate from primitive tessellation LOD
