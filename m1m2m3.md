...
User types prompt  →  AiAssistant::sendAsync(prompt, currentXml)
                  ...
                  model: claude-sonnet-4-6  (default; user-editable)
...
- **Model** field (default `claude-sonnet-4-6`)
...
| `src/MeshCraft/AiAssistant.cpp` | HTTP + threading implementation (cpp-httplib, `std::async`) |
