...
| `plan_20260726.md` | The 2,743-line active backlog immediately before its 2026-07-26 reduction. It contains completed-task narratives, prior session logs, audit evidence, and old status claims preserved verbatim. | Root `plan.md` (bounded active queue and release gates) and `NEXT.md` (current handoff). Consult this archive only for historical evidence or task-resolution detail. |
